...
Event bus with CQRS pattern — Command/Query/Event separation with typed channels, event store, and projections
...
```bash
git clone https://github.com/SuperInstance/cortex-bus
cd cortex-bus
```
